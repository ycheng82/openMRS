...
<!--
 ...
 -->
            <a href="pharmDispenseReturnPrescriptions.htm"><spring:message code="usagestatistics668.pres" /></a> 
	</li>
        ...
        <li>
            <a href="pharmDispenseReturnPrescriptions.htm"><spring:message code="usagestatistics668.invmgmt" /></a>
        </li>
        <li>
