...
import org.openmrs.module.usagestatistics668.Constants;
import org.openmrs.module.usagestatistics668.ActionCriteria;
import org.openmrs.module.usagestatistics668.db.hibernate.HibernateAccessPatientDAO;
import org.openmrs.module.usagestatistics668.util.PagingInfo;
...
public abstract class StatsQueryController extends AbstractController {
	...
	protected static final Log log = LogFactory.getLog(HibernateAccessPatientDAO.class);
