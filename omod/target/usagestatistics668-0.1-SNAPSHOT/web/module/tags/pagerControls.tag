...
<input type="button"
	...
	title="<spring:message code="usagestatistics668.pager.first" />"
/>
...
<input type="button"
	...
	title="<spring:message code="usagestatistics668.pager.previous" />"
/>
...
<input type="button"
	...
	onclick="pager_set_offset(${pagingInfo.pageOffset + pagingInfo.pageSize})"
	title="<spring:message code="usagestatistics668.pager.next" />"
/>
...
<input type="button"
	...
	title="<spring:message code="usagestatistics668.pager.last" />"
/>