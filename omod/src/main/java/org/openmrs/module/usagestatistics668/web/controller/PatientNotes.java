...
/**
 * This class is found by spring because we put "org.openmrs.module.usagestatistics668"
...
public class PatientNotes implements org.springframework.web.servlet.mvc.Controller{
 ...
 public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("PatientNotes.handleRequest..Patient Id: " + patientId);
        Patient p = Context.getPatientService().getPatient(patientId);
        System.out.println("portlet controller patient notes in BasicModuleRegimenController");
        if (p == null) {
	...
	List<Note> notes = Context.getService(NoteService.class).getNotesByPatient(p);
        map.put("notes", notes);
        * 
        */
        ...
        return new ModelAndView("/module/usagestatistics668/portlets/patientNotes", map);
    }
    ...
    /**
     * This method is called when the url /openmrs/module/usagestatistics668/notes.form
     ...
     */
    @RequestMapping("/module/usagestatistics668/notes")
     ...
     * /module/usagestatistics668/addNote.form .
     *
