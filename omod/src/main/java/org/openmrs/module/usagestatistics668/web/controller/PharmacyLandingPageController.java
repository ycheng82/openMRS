...
@Controller
@RequestMapping(value = "module/usagestatistics668/pharmacyLandingPage.form")
public class PharmacyLandingPageController {
	...
	private final String SUCCESS_FORM_VIEW = "/module/usagestatistics668/pharmacyLandingPage";  
