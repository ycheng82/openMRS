...
/**
 * This class configured as controller using annotation and mapped with the URL of 'module/usagestatistics668/usagestatistics668Link.form'.
 */
@Controller
@RequestMapping(value = "module/usagestatistics668/usagestatistics668Link.form")
public class BasicModuleFormController{
	...
	private final String SUCCESS_FORM_VIEW = "/module/usagestatistics668/usagestatistics668Form";
	...
	protected PatientAndNotes formBackingObject(HttpServletRequest request) throws Exception {
		...
		// be set by the SaveHandler because we called a method that started with 'save' and the
		// first argument was an "Auditable" object
