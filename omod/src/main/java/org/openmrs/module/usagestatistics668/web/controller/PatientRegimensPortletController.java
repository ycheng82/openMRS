...
//@RequestMapping(value = "/module/usagestatistics668/addNote")
//public class PatientRegimensPortletController implements Controller {
public class PatientRegimensPortletController{
    
    	private final String SUCCESS_FORM_VIEW = "/module/usagestatistics668/portlets/patientRegimens";  
    ...
    public ModelAndView handleRequest1(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        return new ModelAndView("/module/usagestatistics668/portlets/patientRegimens", map);
    }
*/
