...
public class AccessEncounter {
   ...
   public Integer getEncounter_id() { return this.encounter_id; }
   public void setEncounter_id(Integer encounter_id) { this.encounter_id = encounter_id; }
